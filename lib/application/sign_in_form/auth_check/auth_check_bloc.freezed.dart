...
class _$_SignedOut implements _SignedOut {
  ...
  @override
  String toString() {
    return 'AuthCheckEvent.signedOut()';
  }
...
abstract class _SignedOut implements AuthCheckEvent {
...
/// @nodoc
class __$$_InitialCopyWithImpl<$Res> extends _$AuthCheckStateCopyWithImpl<$Res>
...
abstract class Authenticated implements AuthCheckState {
  const factory Authenticated({required final CurrentUser user}) =
      _$Authenticated;
